...
const styles = StyleSheet.create({
  ...
  basePillText: { fontSize: 12.5, color: st.muted },
  ...
  addRequiredText: { fontSize: 13, color: st.text },
  ...
  checkMark: { color: st.onPrimary, fontSize: 12, lineHeight: 14, fontWeight: '700' },
  preview: { borderWidth: 1, borderColor: st.border, borderRadius: 10, padding: 16, backgroundColor: st.softBg },
  previewRow: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 10,
  ...
  previewCustomInput: { flex: 1, height: 30, borderRadius: 6, backgroundColor: st.panelBg, borderWidth: 1, borderColor: st.primary },
  previewDropdown: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 10 },
  previewDropdownText: { fontSize: 13, color: st.muted, flexShrink: 1 },
